...
position is categorical, pushups is numerical. so we use numerical ~ categorical graphical: boxplot
summary: data summary
inference: t-test compare means
...
This boxplot shows the correlation between the position of the player vs how many push ups they can do. 
...
This illustration shows the summary of the players data set
...
```
This t-test shows the results of pushups by position
...
The t-test to compare means has a p-value of 0.000009421. This is less then 0.05, therefore we reject the null hypothesis, and conclude that we have evidence that there is a difference in the average number of push-ups that can be done in 2 minutes by line and skill players.
